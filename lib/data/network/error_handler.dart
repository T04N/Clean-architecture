...
class ErrorHandler implements Exception {
  ...
  Failure _handleError(DioException error) {
    switch (error.type) {
      ...
      case DioExceptionType.badResponse: // Updated from DioErrorType.response to DioExceptionType.badResponse
...
class ResponseCode {
  ...
  static const int INTERNAL_SERVER_ERROR = 500; // failure, crash happened on server side
...
class ResponseMessage {
  ...
  static const String INTERNAL_SERVER_ERROR = "some thing went wrong, try again later"; // failure, crash happened on server side
