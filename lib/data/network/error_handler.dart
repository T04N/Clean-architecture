...
enum DataSource {
  ...
  UNKNOWN // Added UNKNOWN to handle default cases
}
...
class ResponseCode {
  ...
  static const int BAD_REQUEST = 400; // failure, api request invalid
  ...
  static const int DEFAULT = 666; // failure, crash happened on server side
